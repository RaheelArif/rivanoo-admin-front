...
import PasswordModalGermany from "../../components/PasswordModalGermany";
import { useSelector } from "react-redux";

const GermanyAppPage = () => {
  const navigate = useNavigate();
 
  const isAuthGermany = useSelector((state) => state.password.isAuthGermany);
